"""
Optimized Blelloch parallel prefix scan operations for LASP.
...
Optimizations:
- Simple, proven algorithm (no block pipelining overhead)
- Async isend/irecv for exclusive conversion
